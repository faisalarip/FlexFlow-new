...
export default function DifficultyNotifications() {
  ...
  return (
    <div className="relative">
      ...
      {/* Notifications Panel */}
      {showNotifications && (
        <div className="absolute right-0 top-12 w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 max-h-[80vh] overflow-hidden">
          {/* Header */}
          ...
          <div className="max-h-96 overflow-y-auto">
            ...
            {recommendations?.overallRecommendation && (
              <div className="p-4 bg-gradient-to-r from-purple-50 to-blue-50 border-b">
                <h4 className="font-medium text-purple-800 mb-2">🎯 Overall Assessment</h4>
                <p className="text-sm text-purple-700">{recommendations.overallRecommendation}</p>
              </div>
            )}
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-medium text-gray-800">Exercise Adjustment</span>
                            <Badge 
                              variant="outline" 
                              className={getConfidenceColor(adjustment.confidenceScore)}
                            >
              ...
              <div>
                ...
                <div className="space-y-0">
                  {recommendations.exercises.map((rec) => (
                    <div key={rec.exerciseId} className="p-4 border-b border-gray-100">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h5 className="font-medium text-gray-800">{rec.exerciseName}</h5>
            ...
            {totalNotifications === 0 && !loadingPending && !loadingRecommendations && (
              <div className="p-8 text-center">
                ...
                <h4 className="font-medium text-gray-600 mb-2">All Caught Up!</h4>
          ...
          {/* Footer */}
          <div className="p-3 bg-gray-50 rounded-b-2xl border-t text-center">
