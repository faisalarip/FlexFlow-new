...
export default function WorkoutLogger() {
  ...
  return (
    <section id="workout-logger" className="relative bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-900 rounded-3xl shadow-2xl border border-indigo-700/50 p-8 overflow-hidden">
